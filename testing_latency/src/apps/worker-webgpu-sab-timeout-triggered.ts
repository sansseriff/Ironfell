...
export class WorkerWebGPUSabTimeoutTriggeredApp implements LatencyTestApp {
  readonly name = 'worker-webgpu-sab-timeout-triggered';
  ...
  async mount(root: HTMLElement, options: TestOptions): Promise<void> {
    ...
    this.worker = new Worker(new URL('../workers/worker-webgpu-sab-timeout-triggered.ts', import.meta.url), { type: 'module' });
