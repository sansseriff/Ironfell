 ...
 * @returns {WinitMainHandle}
 */
export function start_winit_main(canvas, options, on_frame) {
    const ret = wasm.start_winit_main(canvas, options, on_frame);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return WinitMainHandle.__wrap(ret[0]);
}
 ...
 * @param {any} options
 * @param {Function} on_frame
 * @returns {BevyMainHandle}
 */
export function start_bevy_main(canvas_id, options, on_frame) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.start_bevy_main(ptr0, len0, options, on_frame);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return BevyMainHandle.__wrap(ret[0]);
}
 ...
 * @param {any} options
 * @param {Function} on_frame
 * @returns {Promise<WgpuWorkerHandle>}
 */
export function start_wgpu_worker(canvas, options, on_frame) {
    const ret = wasm.start_wgpu_worker(canvas, options, on_frame);
    return ret;
}

/**
 * @param {OffscreenCanvas} _canvas
 * @param {any} _options
 * @param {Function} _on_frame
 * @returns {Promise<any>}
 */
export function start_bevy_worker(_canvas, _options, _on_frame) {
    const ret = wasm.start_bevy_worker(_canvas, _options, _on_frame);
    return ret;
}
 ...
 * @returns {Promise<any>}
 */
export function start_bevy_vello_worker(_canvas, _options, _on_frame) {
    const ret = wasm.start_bevy_vello_worker(_canvas, _options, _on_frame);
    return ret;
}

function __wbg_adapter_38(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures_____invoke__he8af2f093d91a0ee(arg0, arg1, arg2);
}

function __wbg_adapter_41(arg0, arg1, arg2) {
    wasm.closure67410_externref_shim(arg0, arg1, arg2);
}

function __wbg_adapter_44(arg0, arg1) {
    wasm.wasm_bindgen__convert__closures_____invoke__h38142521103eab74(arg0, arg1);
}

function __wbg_adapter_53(arg0, arg1, arg2, arg3) {
    wasm.closure67411_externref_shim(arg0, arg1, arg2, arg3);
}

function __wbg_adapter_62(arg0, arg1, arg2) {
    wasm.closure67595_externref_shim(arg0, arg1, arg2);
}

function __wbg_adapter_978(arg0, arg1, arg2, arg3) {
    wasm.closure67621_externref_shim(arg0, arg1, arg2, arg3);
}
...
const BevyMainHandleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_bevymainhandle_free(ptr >>> 0, 1));

export class BevyMainHandle {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(BevyMainHandle.prototype);
        obj.__wbg_ptr = ptr;
        BevyMainHandleFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        BevyMainHandleFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_bevymainhandle_free(ptr, 0);
    }
    /**
     * @param {any} pointer
     * @param {any} rendered
     */
    start(pointer, rendered) {
        const ret = wasm.bevymainhandle_start(this.__wbg_ptr, pointer, rendered);
        if (ret[1]) {
...
const WgpuWorkerHandleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_wgpuworkerhandle_free(ptr >>> 0, 1));

export class WgpuWorkerHandle {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WgpuWorkerHandle.prototype);
        obj.__wbg_ptr = ptr;
        WgpuWorkerHandleFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WgpuWorkerHandleFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wgpuworkerhandle_free(ptr, 0);
    }
    /**
     * @param {any} pointer
     * @param {any} rendered
     */
    start(pointer, rendered) {
        const ret = wasm.wgpuworkerhandle_start(this.__wbg_ptr, pointer, rendered);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    pointer_down(point) {
        const ret = wasm.wgpuworkerhandle_pointer_down(this.__wbg_ptr, point);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    pointer_move(point) {
        const ret = wasm.wgpuworkerhandle_pointer_move(this.__wbg_ptr, point);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
     ...
     */
    pointer_up(point) {
        const ret = wasm.wgpuworkerhandle_pointer_up(this.__wbg_ptr, point);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    stop() {
        wasm.wgpuworkerhandle_stop(this.__wbg_ptr);
    }
    dispose() {
        wasm.wgpuworkerhandle_dispose(this.__wbg_ptr);
    }
}

const WinitMainHandleFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_winitmainhandle_free(ptr >>> 0, 1));

export class WinitMainHandle {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WinitMainHandle.prototype);
        obj.__wbg_ptr = ptr;
        WinitMainHandleFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WinitMainHandleFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_winitmainhandle_free(ptr, 0);
    }
    /**
     * @param {any} pointer
     * @param {any} rendered
     */
    start(pointer, rendered) {
        const ret = wasm.winitmainhandle_start(this.__wbg_ptr, pointer, rendered);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_new_e30c39c06edaabf2 = function(arg0, arg1) {
        try {
            ...
            var cb0 = (arg0, arg1) => {
                ...
                state0.a = 0;
                try {
                    return __wbg_adapter_978(a, state0.b, arg0, arg1);
                } finally {
                    state0.a = a;
                }
            };
    ...
    imports.wbg.__wbg_now_4761d8609756a8e2 = function() {
    ...
    imports.wbg.__wbg_requestAnimationFrame_afe7016446491793 = function(arg0) {
    ...
    imports.wbg.__wbg_strokeRect_078ab819d5dff25e = function(arg0, arg1, arg2, arg3, arg4) {
    ...
    imports.wbg.__wbg_webkitExitFullscreen_8a70718129b220d1 = function(arg0) {
    ...
    imports.wbg.__wbg_wgpuworkerhandle_new = function(arg0) {
        const ret = WgpuWorkerHandle.__wrap(arg0);
        return ret;
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper82639 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_41);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82640 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_44);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82641 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_41);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82642 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_41);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82643 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_41);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82644 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_53);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82645 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_41);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82646 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_41);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper82647 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67409, __wbg_adapter_41);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper83105 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 67594, __wbg_adapter_62);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('latency_rust_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
