...
export class Worker2DSabApp implements LatencyTestApp {
  readonly name = 'worker-2d-sab';
  ...
  async mount(root: HTMLElement, options: TestOptions): Promise<void> {
    ...
    this.worker = new Worker(new URL('../workers/worker2d-sab.ts', import.meta.url), { type: 'module' });
